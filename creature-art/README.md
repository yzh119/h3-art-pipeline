...
[`docs/modders/HD_Graphics.md`](https://github.com/vcmi/vcmi/blob/develop/docs/modders/HD_Graphics.md).
...
[`docs/modders/Animation_Format.md`](https://github.com/vcmi/vcmi/blob/develop/docs/modders/Animation_Format.md) lets a
...
python3 creature-art/def_extract.py info "$LOD" CSKELE.DEF --anchor
```
...
```bash
python3 creature-art/def_extract.py export "$LOD" CSKELE.DEF --out ref/cskele
...
blender -b --python creature-art/render_sprites.py -- \
...
```bash
python3 creature-art/render_sprites.py -- ... --scale 2   # 900x800,  ground 534, creature 158 px
python3 creature-art/render_sprites.py -- ... --scale 4   # 1800x1600, ground 1068, creature 316 px
```
...
```bash
python3 creature-art/validate_creature_animation.py ~/vcmi-mods/hd-creatures
```
